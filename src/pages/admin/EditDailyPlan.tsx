...
const EditPilotPlan = () => {
    ...
    // Fetch thông tin kế hoạch theo ID
    const fetchPlanData = async () => {
        ...
        try {
            ...
            console.log("Plan data:", data.data.content);

            // Populate form với dữ liệu từ API
            form.reset({
                planDate: data.data.content.planDate || "",
                operationsOfficer: data.data.content.operationsOfficer || "",
                pilotOfficer: data.data.content.pilotOfficer || "",
                dutyPhone: data.data.content.dutyPhone || "",
                transportationInfo: data.data.content.transportationInfo || "",
                honNetPositionPlan: data.data.content.honNetPositionPlan || "",
            });
        } catch (error) {
            console.error(error);
            toast({
    ...
    const filteredAssignments = useMemo(() => {
        ...
        if (statusFilter.trim()) {
            ...
            result = result.filter((a) => (a.status || "").toLowerCase().includes(s));
        }
        return result;
    ...
    const handleUpdatePlan = async () => {
        ...
        try {
            ...
            const res = await pilotPlanService.updatePlan(planData);
                    ...
                    <div className="mt-8 border-[4px] border-white overflow-hidden" style={{ boxShadow: "0 0 0 1px #003399 inset" }}>
                        <div className="bg-[#003399] text-white">
                            ...
                            <div className="grid grid-cols-2 border-b-[3px] border-white/80">
                                <div className="px-6 py-3 border-r-[3px] border-white/80 flex flex-row items-center justify-center gap-2">
                                    ...
                                    <span className="font-extrabold text-lg">{operationsOfficer || ""}</span>
                                </div>
                                <div className="px-6 py-3 flex flex-row items-center justify-center gap-2">
                                    ...
                                    <span className="font-extrabold text-lg">{pilotOfficer || ""}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#003399] text-white p-4">
                            <div className="flex justify-between items-center gap-4 mb-3">
                                <div className="flex gap-2 items-center border-white rounded-md">
                                            ...
                                            <>
                                                {paginatedAssignments.map((a, i) => {
                                                    ...
                                                    return (
                                                        <tr key={a.id}>
                                                            ...
                                                            <td className="text-center border-[3px] border-white px-2 py-2">
                                                                {isEditingThis ? renderEditableCell(a.transportMethod, "transportMethod") : (a.transportMethod || "-")}
                                                            </td>
                                                            <td className="text-center border-[3px] border-white px-2 py-2">
                                                ...
                                                {isAddingNew && (
                                                    <tr className="bg-[#003399]">
                                                        ...
                                                        <td className="border-[3px] border-white px-2 py-2">
                                                            {renderEditableCell("", "pilotRoute", "text", true)}
                                                        </td>
                                                        <td className="text-center border-[3px] border-white px-2 py-2">
                                                            <div className="flex gap-1 justify-center">
                                                                <Button
