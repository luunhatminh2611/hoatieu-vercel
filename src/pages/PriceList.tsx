...
import { FileText, Eye, Plus, Pencil, Trash2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-16 sm:mt-[80px] pb-16">
        ...
        <section className="bg-gradient-to-r from-primary to-accent text-primary-foreground py-16">
          <div className="max-w-7xl mx-auto px-8 text-center">
            ...
            <p className="text-xl max-w-2xl mx-auto">
              Tra cứu bảng giá dịch vụ hoa tiêu hàng hải theo từng thời kỳ
            </p>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-8 py-16 space-y-6">
          ...
          <Card className="mt-8">
            <CardHeader>
              <CardTitle className="text-xl text-primary">Lưu Ý</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-muted-foreground">
              <p>• Bảng giá có thể thay đổi tùy theo loại tàu, trọng tải, và khoảng cách di chuyển.</p>
              <p>• Giá dịch vụ đã bao gồm VAT theo quy định của pháp luật.</p>
              <p>• Để biết thêm chi tiết hoặc nhận báo giá cụ thể, vui lòng liên hệ với bộ phận kinh doanh.</p>
              <p>• Các tài liệu dạng PDF yêu cầu phần mềm Adobe Reader hoặc trình duyệt hỗ trợ để xem.</p>
            </CardContent>
            <ServicePriceModal
              open={openModal}
